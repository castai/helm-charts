...
![Version: 0.1.188](https://img.shields.io/badge/Version-0.1.188-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.95.1](https://img.shields.io/badge/AppVersion-v0.95.1-informational?style=flat-square)
...
| clusterAutoscaler | object | `{"args":{"scale-down-delay-after-add":"0s","scale-down-delay-after-delete":"0s","scale-down-delay-after-failure":"30s","scale-down-unneeded-time":"30s","scale-down-unready-time":"1m","scan-interval":"10s"},"enabled":false}` | Configuration for injecting optimized CLI args into cluster-autoscaler pods. The mutating webhook detects CA pods on CREATE and appends configured args. Existing flags set by the customer are never overridden. |
