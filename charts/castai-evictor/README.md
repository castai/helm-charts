...
| clusterVPA | object | `{"enabled":true,"pollPeriodSeconds":300,"repository":"us-docker.pkg.dev/castai-hub/library/cpa/cpvpa","resources":{},"version":"v0.8.13"}` | Cluster proportional vertical autoscaler for the evictor deployment https://github.com/kubernetes-sigs/cluster-proportional-vertical-autoscaler. |
