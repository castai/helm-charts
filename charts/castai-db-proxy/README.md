...
| pooling.proxySql.users | list | `[]` | Inline list of upstream DB users (raw username/password). Mutually exclusive with usersSecretRef. When set, a Secret is generated from these entries in username:password line format. |
