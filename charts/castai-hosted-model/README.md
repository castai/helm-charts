...
|------------|------|---------|
| file://child-charts/sglang | sglang | 0.2.0 |
...
| podAutoscaler.enabled | bool | `false` | Specifies if pod autoscaler should be enabled. Relevant for both vllm and sglang deployments |
...
| sglang.enabled | bool | `false` | Specifies if SGLang model should be deployed. Mutually exclusive with vllm.enabled. |
