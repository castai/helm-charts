...
| workloadsAnnotations | object | `{}` | CAST.AI workload optimization annotations. These annotations allow users to customize workload behavior. Ref: https://docs.cast.ai/docs/workload-autoscaling |
| workloadsAnnotations | object | `{}` | CAST.AI workload optimization annotations. Set to null to disable workload annotations entirely. Customize values to override with your own annotations. Ref: https://docs.cast.ai/docs/workload-autoscaling |
