...
![Version: 0.45.0-rc1](https://img.shields.io/badge/Version-0.45.0--rc1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| proxy.coredumpCollection | string | `"None"` | Disable core dump collection by default |
