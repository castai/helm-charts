...
| endpoints | list | `[{"hostname":"dbo-e2e-postgres.dbo-e2e-customer.svc.cluster.local","name":null,"port":5432,"servicePort":5432,"targetPort":5432}]` | A list of upstream database endpoints |
