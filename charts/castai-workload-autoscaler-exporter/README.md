...
| exporter.serviceAccount.rbac | bool | `true` |  |
...
| priorityClass | object | `{"enabled":false,"name":"system-cluster-critical"}` | K8s priority class for the exporter pods. When enabled, reduces the chance of kubelet preemption. |
...
| prometheus.image.tag | string | `"v3.11.3"` |  |
| prometheus.podSecurityContext.fsGroup | int | `65534` |  |
| prometheus.podSecurityContext.runAsGroup | int | `65534` |  |
| prometheus.podSecurityContext.runAsNonRoot | bool | `true` |  |
| prometheus.podSecurityContext.runAsUser | int | `65534` |  |
| prometheus.podSecurityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
