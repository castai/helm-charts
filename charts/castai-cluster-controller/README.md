...
| castai | object | `{"apiKey":"","apiKeySecretRef":"","apiURL":"https://api.cast.ai","clusterID":"","clusterIdConfigMapKeyRef":{"key":"CLUSTER_ID","name":""},"clusterIdSecretKeyRef":{"key":"CLUSTER_ID","name":""}}` | CAST AI API configuration. |
...
| castai.clusterID | string | `""` | CASTAI Cluster unique identifier. clusterID, clusterIdSecretKeyRef and clusterIdConfigMapKeyRef are mutually exclusive |
